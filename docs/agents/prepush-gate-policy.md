...
lastReviewedNote: 'Reviewed for Platform #1120: focused Open Data service and component tests use the existing Jest path; pre-push ownership and trigger policy are unchanged.'
---
