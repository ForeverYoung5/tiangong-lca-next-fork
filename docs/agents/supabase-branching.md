...
lastReviewedNote: 'Reviewed Platform #1120: frontend Open Data queries and publication commands preserve the database/Edge ownership boundary and existing environment-selection policy.'
---
