export default {
  ...
  'pages.button.delete.confirm': '确定要删除这条数据吗？',
  ...
  'pages.button.model.lifecyclemodel': '生命周期模型信息',
  ...
  'pages.button.model.setReference': '设为参考',
  ...
  'pages.openData.source.filter': '数据来源筛选',
  'pages.openData.source.all': '全部数据',
  'pages.openData.source.literature': '文献数据',
  'pages.openData.source.enterprise': '企业数据',
  'pages.openData.publication.filter': '发布状态筛选',
  'pages.openData.publication.status': '发布状态',
  'pages.openData.publication.all': '全部发布状态',
  'pages.openData.publication.published': '已发布',
  'pages.openData.publication.unpublished': '未发布',
  'pages.openData.publication.publishSelected': '发布选中项（{count}）',
  'pages.openData.publication.success': '已发布 {count} 个过程版本。',
  'pages.openData.publication.error': '发布选中的过程失败。',
  ...
  'pages.datasetUuidMention.entityKind.unknown': '未知数据类型（{kind}）',
  ...
  'page.options.savesuccess': '数据保存成功。',
  ...
  'pages.validationIssues.sdkDetail.suggestedFix.quantitative_reference_count_invalid': '请选择且仅选择一项作为定量参考。',
  ...
  'pages.table.filter.all.workflowStatus': '所有工作流状态',
  'pages.table.filter.all.datasetType': '数据集类型',
  'pages.table.filter.workflowStatus.workingDraft': '工作草稿',
  'pages.table.filter.workflowStatus.finalDraftForExternalReview': '用于外部评审的最终草稿',
  'pages.table.filter.workflowStatus.dataSetFinalised': '数据集已定稿；已完全发布',
  ...
  'pages.review.submit.button': '提交审核',
  'pages.review.submit.error': '提交审核失败。',
  'pages.review.reference.table': '数据类型',
  'pages.review.reference.version': '数据版本',
  'pages.review.reference.paths': '引用路径',
  'pages.review.reference.status.approved': '已通过',
  ...
  'pages.review.simpleDecision.approveConfirm': '确认通过该审核？',
  'pages.review.simpleDecision.approveSuccess': '审核意见已通过。',
  'pages.review.simpleDecision.rejectSuccess': '审核驳回意见已提交。',
  'pages.review.simpleDecision.error': '审核意见提交失败。',
