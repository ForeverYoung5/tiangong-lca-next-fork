...
describe('route access config', () => {
  ...
  it('places data processing after the user and team data modules', () => {
    ...
    expect(routePaths.indexOf('/sample-library')).toBeGreaterThan(routePaths.indexOf('/tedata'));
    expect(routePaths.indexOf('/data-processing')).toBeGreaterThan(
      routePaths.indexOf('/sample-library'),
    );
