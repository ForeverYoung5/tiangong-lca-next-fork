...
lastReviewedNote: 'Reviewed for Platform #1115: the installed SDK contract now qualifies TIDAS SDK 0.4.0 and required Process general comments; local bootstrap and the default work loop are unchanged.'
---
